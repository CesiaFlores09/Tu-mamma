    ...
    methods:{
        ...
        guardarCliente(){
            ...
            if(this.cliente.accion=="nuevo"){
                ...
                alumnos.push(this.cliente);
            } else if(this.cliente.accion=="modificar"){
                let index = alumnos.findIndex(cliente=>cliente.idCliente==this.cliente.idCliente);
                alumnos[index] = this.cliente;
        ...
        obtenerClientes(valor=''){
            this.alumnos = [];
            let alumnos = JSON.parse(localStorage.getItem('alumnos')) || [];
            this.alumnos = alumnos.filter(cliente=>cliente.nombre.toLowerCase().indexOf(valor.toLowerCase())>-1);
        },
        nuevoCliente(){
        ...
        <div id="appSistemaClientes">
            <div class="card text-white" id="carCliente">
                ...
                <div class="card-body text-dark">
                    ...
                    <div class="col col-md-2">
                        <input title="Ingrese la Zona"  v-model="cliente.zona" required type="text" class="form-control">
                    </div>
                </div>
            ...
            <div class="card text-white" id="carBuscarCliente">
                ...
                <div class="card-body">
                    <table class="table table-dark table-hover">
                        ...
                        <tbody>
                            <tr v-for="item in alumnos" @click='modificarCliente( item )' :key="item.idCliente">
                                <td>{{item.codigo}}</td>
                                <td>{{item.nombre}}</td>
